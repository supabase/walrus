-- Composite use cases: multiple v2 filters combined with AND semantics, mixing
-- every new operator and negations. realtime.is_visible_through_filters requires
...
select filters_v2 from realtime.subscription where subscription_id = '00000000-0000-0000-0000-0000000000aa';
